...
describe SubjectsController do
  ...
  describe "GET index" do
    xit "assigns all subjects as @subjects" do
  ...
  describe "GET show" do
    xit "assigns the requested subject as @subject" do
      subject = Subject.create! valid_attributes
  ...
  describe "GET new" do
    xit "assigns a new subject as @subject" do
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      xit "assigns a newly created but unsaved subject as @subject" do
  ...
  describe "PUT update" do
    describe "with valid params" do
      xit "updates the requested subject" do
        subject = Subject.create! valid_attributes
      ...
      xit "redirects to the subject" do
        subject = Subject.create! valid_attributes
        put :update, {:id => subject.to_param, :subject => valid_attributes}, valid_session
    ...
    describe "with invalid params" do
      xit "assigns the subject as @subject" do
        subject = Subject.create! valid_attributes
        # Trigger the behavior that occurs when invalid params are submitted
        Subject.any_instance.stub(:save).and_return(false)
  ...
  describe "DELETE destroy" do
    xit "destroys the requested subject" do
      subject = Subject.create! valid_attributes
      expect {
    ...
    xit "redirects to the subjects list" do
      subject = Subject.create! valid_attributes
      delete :destroy, {:id => subject.to_param}, valid_session
